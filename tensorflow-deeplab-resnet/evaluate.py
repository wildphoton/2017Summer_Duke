...
DATA_DIRECTORY = '/home/helios/Documents/data/igarssTrainingAndTestingData/validation_patches_images_size41'
DATA_LIST_PATH = './dataset/val_sc.txt'
IGNORE_LABEL = 0
NUM_CLASSES = 2
NUM_STEPS = 61504 # Number of images in the validation set.
RESTORE_FROM = './snapshots/sc_batchsize16/model.ckpt-67000'
...
def main():
    ...
    pred = tf.expand_dims(raw_output_up_argmax, dim=3) # Create 4-d tensor.
    ...
    for step in range(args.num_steps):
        ...
        if step % 100 == 0:
            print('step {:d} Mean IoU: {:.3f}'.format(step, mIoU.eval(session=sess)))
