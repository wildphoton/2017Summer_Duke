...
def read_images_from_disk(input_queue, input_size, random_scale,  random_mirror, random_rotate, ignore_label, img_mean, img_std):  #optional pre-processing arguments
...
class ImageReader(object):
    ...
    def __init__(self, data_dir, data_list, input_size, 
                 random_scale, random_mirror, random_rotate, ignore_label, img_mean, coord, img_std=None):
        ...
        self.image, self.label = read_images_from_disk(self.queue, self.input_size, random_scale, random_mirror, random_rotate, ignore_label, img_mean, img_std)
    ...
    def dequeue(self, num_elements):
        ...
        image_batch, label_batch = tf.train.batch([self.image, self.label], num_elements, capacity=num_elements*4, allow_smaller_final_batch=False)
